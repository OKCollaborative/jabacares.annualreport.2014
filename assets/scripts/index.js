  ...
  init: function () {
    ...
    var financials = {
      revenues:[
        ...
        { value: 639075,  color: '#368a8d', class:'affiliate', label: 'Revenue from Affiliates' }
      ],
      expenses:[
        ...
        { value: 812066,  color: '#eb9000', class:'affiliate',      label: 'Affiliate Operations' },
    ...
    var size = {width:600,height:600}, position = {x:size.width/2,y:size.height/2}, radius = {inner:220, outer: 290};
    chartRevenues = Raphael("revenue-chart", size.width, size.height).donutChart(position.x, position.y, radius.outer, radius.inner, financials.revenues, "#fff");
    chartExpenses = Raphael("expense-chart", size.width, size.height).donutChart(position.x, position.y, radius.outer, radius.inner, financials.expenses, "#fff");
