...
module.exports = {
	...
	connect: function connect(div1, div2, lineOptions) {
	  ...
	  var htmlLine = "<div class='connector' style='border-top:" + lineOptions.weight + "px dotted " + lineOptions.color + ";left:" + line.center.x + "px; top:" + line.center.y + "px; width:" + line.length + "px;" + this.transform(line.angle) + "'/>";
	  //
